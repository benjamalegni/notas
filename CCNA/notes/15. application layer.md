...
- usa UDP en comunicaciones cliente-servidor
pasos:
...
>
```
para enviar mails solo se usan protocolos: SMTP y DNS
para la descarga de mails desde el servidor se usan: IMAP, POP y POP3